...
// La radice dell'applicazione e' la cartella sopra `public/`. Il rilevamento
// del layout dell'hosting condiviso (`../private/`, hosting legacy) e' stato tolto il
// 2026-09-04 (revisione P10): l'unico deploy e' nginx + PHP-FPM con
// `public/` come webroot (infra/nginx).
$appRoot = __DIR__ . '/..';
