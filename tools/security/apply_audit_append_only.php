...
$tables = [
    ...
    // 2026-09-15 — era false, ma la purga (tabelle_da_purgare.php) la svuota dopo
    // dieci anni, come dicono registro e informativa: il trigger l'avrebbe
    // impedito. Si riapplica con --apply.
    'consent_audit'          => ['purgeable' => true],
