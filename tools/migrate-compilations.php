 ...
 *
 * DISATTIVATO (2026-09-04): la migrazione ADR-026 Step 5 è conclusa e, dalla
 * migration 101, `data_json` è NULL sulle righe cifrate (il contenuto vive in
 * `data_ct` con la chiave del docente). Questo strumento leggeva e scriveva
 * `data_json` in chiaro: oggi non troverebbe nulla da leggere e, scrivendo,
 * lascerebbe una riga con due versioni. Resta come documentazione; per
 * toccare le compilazioni usare App\Repositories\Risdoc\CompilationRepository.
 */
fwrite(STDERR, "DISATTIVATO: le compilazioni sono cifrate (migration 101). Usare CompilationRepository.\n");
exit(2);

// @phpstan-ignore-next-line — codice storico, non più raggiungibile.
