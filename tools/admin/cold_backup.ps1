...
# ============================================================
# Il nome del remote e' cambiato col rebranding (b2-fismapant -> b2-pantedu)
...
$B2Remote = 'b2-pantedu'
# Il bucket ha ancora il nome del brand precedente: su B2 i nomi sono unici
# a livello globale e non rinominabili, servirebbe crearne uno nuovo e
# migrare 251 MiB di archivi. Verificato con `rclone lsd` il 2026-08-31.
$B2Bucket = 'fismapant-backup-vps'
