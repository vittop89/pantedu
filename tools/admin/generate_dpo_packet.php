...
| Backup cifrati | Backblaze B2, cifrati lato client prima dell'invio. **Object Lock non attivo** (in roadmap): finché non lo è, chi amministra il server può riscrivere anche la copia remota |
| Audit log append-only | Sette registri protetti da **trigger** a livello di database. Il `REVOKE UPDATE/DELETE` qui indicato fino al 2026-09-22 non era applicabile — la concessione è a livello di database e MariaDB non permette di sottrarre un permesso su singole tabelle — ed era stato sostituito dai trigger già dalla DPIA 1.3 |
...
Per la versione web pubblica: https://pantedu.eu/security
MD;
...
CONTATTI:
  ...
  Pagina pubblica privacy:                 https://pantedu.eu/privacy/informativa
  Pagina pubblica sicurezza:               https://pantedu.eu/security
