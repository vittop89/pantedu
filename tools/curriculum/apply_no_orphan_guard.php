 ...
 *   (Dal 13/9/2026 il migratore conosce DELIMITER — migrazioni 117-120 — e la
 *   121 ricrea questa guardia; lo strumento resta per rimetterla a mano.)
 *
 * USO
...
$sorveglia = [
    ...
    // ADR-037, fase 4c-3 (migrazione 123): della verifica resta nella riga solo
    // la materia; indirizzo e classe stanno nelle sue pubblicazioni.
    'verifica_documents_data'  => ['materia_id'],
    'risdoc_compilations_data' => ['indirizzo_id', 'classe_id'],
    // Il posto di un contenuto e di una verifica sta nelle loro pubblicazioni.
    // Le migrazioni 121 e 123 ricreano la guardia con questo stesso elenco:
    // tenerli uguali.
    'content_publications'     => ['indirizzo_id', 'classe_id', 'subject_id'],
];
