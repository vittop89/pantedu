...
const BUDGETS = {
    ...
    // 2026-09-05 — 25 → 32 kB: quattordici entry in piu' per le ultime viste con
    // JS inline (P8 completato); il bootstrap e' sceso a 116 kB gzip.
    "manifest.json":     { kind: "raw",   maxBytes:  32 * 1024 },
};
