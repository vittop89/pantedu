...
// nell'app. Prima qui si stampavano i primi 16 caratteri di una chiave non
// valida e i primi 8 di una valida: pezzi di un segreto in un terminale. Ora
// si dice solo lo stato.
$chiave = \App\Services\Crypto\ChiaveMadre::dallAmbiente();
echo "[1] KMS_MASTER_KEY in env: ";
if (!$chiave->valida()) {
    echo "❌ " . $chiave->stato() . " (servono 64 caratteri esadecimali)\n";
    exit(1);
}
echo "✅ OK (64 hex)\n";
$kmsMaster = $chiave->byte();
