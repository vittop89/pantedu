...
// 23/9/2026 (A-36) — la chiave si legge in ChiaveMadre: una chiave non valida
// ferma lo strumento dicendo lo stato, non il valore.
$kms = \App\Services\Crypto\ChiaveMadre::dallAmbiente()->byte();
