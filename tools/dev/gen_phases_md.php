 ...
 *
 * Deterministico dal 2026-09-23 (DOC-13): `RecursiveDirectoryIterator` non
 * garantisce l'ordine alfabetico, lo dà il filesystem. I file scansionati si
 * ordinano PRIMA di leggerli: altrimenti sia l'elenco «file principali»
 * (i primi tre incontrati) sia la descrizione a parità di lunghezza (vince la
 * prima incontrata) potevano cambiare da una macchina all'altra a parità di
 * codice, e un passo di CI che confronta l'uscita con `docs/PHASES.md`
 * avrebbe potuto essere rosso senza che nulla fosse davvero cambiato.
 */
...
require_once __DIR__ . '/phases_ordine.php';
uksort($data, 'confrontaPhase');
