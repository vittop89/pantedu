...
$seed->execute(['docente.uno', 'seed@test.local', password_hash('test-seed', PASSWORD_DEFAULT)]);
$seed->execute(['docente.due', 'seed2@test.local', password_hash('test-seed', PASSWORD_DEFAULT)]);
