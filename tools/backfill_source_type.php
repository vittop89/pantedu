...
// --all: riclassifica anche le righe già classificate (da usare dopo una
// correzione della regola, come quella del 2026-09-05 su origin=personal).
$where = in_array('--all', $argv, true) ? '1=1' : 'source_type IS NULL';
$params = [];
if ($typeFilter !== null) {
