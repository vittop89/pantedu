/**
 * Unit test per renameSvgIds + makeSvgPrefix (tikz-svg-ids.js, riesportate da tikz-render-client.js).
 *
...
import { renameSvgIds, makeSvgPrefix } from "../../js/modules/editor/tikz-svg-ids.js";
