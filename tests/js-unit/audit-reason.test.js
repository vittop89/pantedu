...
describe("auditReason", () => {
    ...
    it("accoda la nota dell'utente al contesto", () => {
        // Il trattino semplice al posto della lineetta lunga non e' un capriccio
        // tipografico: «—» sta fuori da ISO-8859-1 e `fetch` rifiuta la
        // richiesta prima di mandarla. Misurato il 21/9/2026 in Chromium — ogni
        // mutazione con un dettaglio moriva li'. La regola sta in
        // tests/js-unit/motivazione-scrivibile-in-intestazione.test.js.
