...
final class AdminPrintControllerTest extends TestCase
{
    ...
    {
        $_SESSION = [];
        // Stessa ragione di TeacherPrintControllerTest: OwnershipService in
        // modalita' DB ignora il JSON sandbox e non registra utenti assenti da
        // `users` ("admin" non e' seedato in pantedu_test). Modalita' file
        // forzata per la durata del test, ripristinata in tearDown.
