...
final class TeacherContentDualWriteTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // (docente.uno). Azzera ogni suo dato cifrato → il guard
    ...
    protected function tearDown(): void
    {
        ...
        Config::set('crypto.read_from', 'plaintext');
    }

    public function testCreateLegacyNoDualWriteOnlyPlaintext(): void
    {
        Config::set('crypto.dual_write', false);  // default false
    ...
    {
        Config::set('crypto.dual_write', true);
        $id = $this->createSampleContent();
    ...
    public function testReadFromCiphertextRoundtrip(): void
    {
        ...
        // Switch read mode
        Config::set('crypto.read_from', 'ciphertext');
    ...
    {
        Config::set('crypto.dual_write', false);  // legacy path
        Config::set('crypto.read_from', 'plaintext');
        $id = $this->createSampleContent();
