 ...
 * Usa teacher_id reali dal DB (docente.uno, docente.due se presenti).
 *
...
final class TeacherCryptoIntegrationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Trova teacher_id reale (docente.uno seed)
    ...
    {
        // Uno shred su un docente senza chiave non deve sollevare.
        $this->expectNotToPerformAssertions();
        $this->svc->shred(999999998);  // identificativo inesistente
    }
