...
for (const preset of PRESETS) {
    test(`Preset ${preset.kind} → tag=${preset.tag} listStyle=${preset.listStyle || "(default)"}`, async ({ bancoEditor }) => {
...
test("Round-trip ALL presets: insert → buildBlocks → _toHtml preserva data-fm-list-style", async ({ bancoEditor }) => {
    const page = bancoEditor.page;
