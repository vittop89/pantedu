 ...
 *
 * NB (2026-08-26): rimosso il test su CopilotController insieme all'endpoint
 * /api/copilot/chat e ai suoi alias legacy. Vedi routes/web.php e
 * docs/legal/ai-act-assessment.md § 3.2.
 *
...
test.describe("Phase 13 — legacy modernization", () => {
    ...
    // Il test su /api/copilot/chat è stato rimosso insieme all'endpoint
    // (2026-08-26). Vedi la nota in routes/web.php e
    // docs/legal/ai-act-assessment.md § 3.2.
