 ...
 *   - i 14 template attesi sono presenti in DB dopo seed (erano 15: il
 *     Modulo di autorizzazione, con campi anagrafici dello studente, e'
 *     stato cancellato dalla migration 102 il 2026-09-04)
...
final class RisdocSeedTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        // deve essere SKIPPED, non ERROR. Un errore permanente in suite abitua
        // a ignorare il rosso e nasconde le regressioni vere.
        // Stesso idioma di CurriculumServiceTest.
        try {
    ...
    public function testTemplatesCountMatchesExpected(): void
    {
        ...
        self::assertGreaterThanOrEqual(14, $n, 'Expected at least 14 seeded templates');
    }
    ...
    public function testStrcompAllPresent(): void
    {
        ...
        // 4, non 5: il Modulo di autorizzazione non c'e' piu' (migration 102).
        self::assertCount(4, $codes);
        foreach ($codes as $code) {
            self::assertStringNotContainsStringIgnoringCase('autorizzazione', (string)$code);
        }
