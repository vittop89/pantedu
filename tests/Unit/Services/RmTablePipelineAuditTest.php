...
final class RmTablePipelineAuditTest extends TestCase
{
    ...
    public function tex_specificWidth_converts_to_cm(): void
    {
        ...
        // Il preambolo del tabular non usa \linewidth (le celle si', dentro
        // le loro minipage: e' relativo alla colonna). Riallineato il 2026-09-04.
        $this->assertSame(1, preg_match('#\\\\begin\{tabular\}\{([^\n]*)\}\\\\hline#', $tex, $pre));
        $this->assertStringNotContainsString('\\linewidth', $pre[1]);
    }
}
