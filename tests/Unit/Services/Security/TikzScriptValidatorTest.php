...
final class TikzScriptValidatorTest extends TestCase
{
    ...
    {
        // Non deve sollevare: `expectNotToPerformAssertions` lo dice a PHPUnit
        // senza fingere un'asserzione che sarebbe sempre vera.
    ...
    {
        $this->expectNotToPerformAssertions();
        TikzScriptValidator::validate('foo<\\/script>bar');  // già con l'escape
    }
