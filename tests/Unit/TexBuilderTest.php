...
final class TexBuilderTest extends TestCase
{
    ...
    public function vf_type_renders_tabularx_with_v_f_columns(): void
    {
        ...
        $tex = (new TexBuilder())->buildFlat($sel);
        // Intestazione della tabella V/F: "# | Affermazione | V | F"
        // (riallineato il 2026-09-04: le colonne non si chiamano piu' Vero/Falso).
        $this->assertStringContainsString('\begin{tabularx}',       $tex);
        $this->assertStringContainsString('\textbf{Affermazione}',  $tex);
        $this->assertStringContainsString('\textbf{V} & \textbf{F}', $tex);
