...
final class FullCycleTest extends TestCase
{
    ...
    private const TEST_ROT = [
        'testEndToEndTexToPtToSchemaToCompilationToTex' =>
            'il body schema-driven rende VUOTO: TexBuilder emette solo l\'header e nessun campo, \'[field-classe]\' non compare. Da distinguere: fixture schema obsoleto oppure regressione del renderer (in tal caso e\' un bug utente-visibile).',
        'testTexOutputSemanticsAfterUserEdit' =>
            'il markup delle liste dopo edit e\' cambiato (\\begin{itemize}).',
    ];
