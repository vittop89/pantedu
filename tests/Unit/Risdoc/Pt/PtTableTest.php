...
final class PtTableTest extends TestCase
{
    ...
    public function testRenderWithCaption(): void
    {
        ...
        $out = PtToTex::render($pt);
        // Niente float `table` (spezzava le sectionbox): tabella centrata e
        // didascalia come testo corsivo sotto. Riallineato il 2026-09-04.
        self::assertStringContainsString('\\begin{center}', $out);
        self::assertStringContainsString('\\textit{Tab. esempio}', $out);
        self::assertStringContainsString('\\end{center}', $out);
        self::assertStringNotContainsString('\\begin{table}', $out);
    }
