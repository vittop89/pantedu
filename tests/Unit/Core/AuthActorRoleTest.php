 ...
 *
 * Le sessioni hanno i claims appena letti (`claims_at`): altrimenti il flag si
 * rilegge dal database, e in locale 'admin' è un utente vero (23/9/2026).
 */
