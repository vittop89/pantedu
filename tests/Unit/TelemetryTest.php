...
{
    private mixed $abilitataPrima = null;

    protected function setUp(): void
    {
        // Dal 23/9/2026 la telemetria legge `app.telemetry_enabled`
        // (TELEMETRY_ENABLED, letta in app/Config/app.php): A-35, ADR-049.
        $this->abilitataPrima = \App\Core\Config::get('app.telemetry_enabled');
        \App\Core\Config::set('app.telemetry_enabled', false);
        unset($_SERVER['X_REQUEST_ID']);
    }

    protected function tearDown(): void
    {
        \App\Core\Config::set('app.telemetry_enabled', $this->abilitataPrima);
    }
    ...
    {
        \App\Core\Config::set('app.telemetry_enabled', true);
