 ...
 *  escapa, poi ripristina SOLO i 4 tag (come PtToHtml::renderInlineText). Le
 *  virgolette codificate in più non cambiano il testo che il campo mostra. */
function cellTextToHtml(text) {
    return escapeHtml(text).replace(/&lt;(\/?)(strong|em|u|code)&gt;/g, "<$1$2>");
}
