 ...
 *   - Wires button stubs: SalvaTEX/ZIP/GENERA/filtri/Editor.
 ...
 *     gli hidden inputs (#Server) che `utilities.js` legge
...
function buildSelectionFromDOM() {
    ...
    return {
        ...
        versions,             // G19.7 — multi-version array per il batch
        ...meta,
        problems,
 ...
 *  VSC, ZIP). Genera 4 varianti SOL/NOR/DSA/DIS [+ B se R].
...
function handleAction(action, btn, ev) {
    switch (action) {
        ...
        // mappiamo a doGenera (modal Server/Locale).
        case "genera":
            doGenera(btn, ev);
            break;
        case "info":
