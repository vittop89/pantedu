...
export const DataManager = {
  ...
  clearRemovedCollexItems () {
    this._state.removedCollexItems = [];
  },
  // Metodi per gestire detachedElemColl
  setDetachedElement (key, value) {
    this._state.detachedElemColl[key] = value;
  },
  getDetachedElement (key) {
    return this._state.detachedElemColl[key];
  },

  async _filterProblemsByValues (currentPageValues) {
  ...
  async updateOptionOnServer (oldValue, newValue, action) {
    try {
