...
// Rete: wafFetch, che su un 403 `waf_challenge` risolve la sfida e ripete la
// richiesta una volta (23/9/2026, A-18: prima qui c'era `fetch` diretta, e il
// chiamante riceveva il 403).
import { fetchCsrf, invalidateCsrfCache, wafFetch } from "./dom-utils.js";
...
async function _fetch(url, opts = {}) {
    ...
    const res = await wafFetch(url, init);
