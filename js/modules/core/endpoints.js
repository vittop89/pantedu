...
export const Endpoints = {
    ...
    files: {
        // 2026-09-20 — tolte `saveTex` e `saveImage` con le loro rotte.
        // `saveImage` la chiamava solo `saveSvgToServer` in
        // editor/content-processor.js, il giro su disco del vecchio editor
        // TikZ; `saveTex` non la chiamava nessuno. Gli SVG li salva
        // `/tikz/save-svg`, i sorgenti TeX `/api/verifica/save-tex`.
    ...
    templates: {
        ...
        //   - pagEsercizi / pagEserciziVer / pagListSidebar: erano del flusso
        //     «crea pagine» legacy, tolto il 2026-09-05 con api-jquery.js.
