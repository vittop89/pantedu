...
/**
 * Tipi brevi usati da alcuni moduli (wizard degli esercizi, costruttore di
 * verifiche): senza questa tabella «err» usciva come avviso e non come errore
 * (revisione architetturale del 23/9/2026, A-21).
 */
const TIPI_BREVI = { ok: "success", warn: "warning", err: "error" };

function dispatch(tipo, title, message, duration) {
    const type = TIPI_BREVI[tipo] ?? tipo;
