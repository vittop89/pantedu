...
export const DOMManager = {
    ...
    injectHiddenForm: function () {
        ...
        // aria-hidden + tabindex=-1: e' un veicolo per il POST a Overleaf, mai
        // un campo da compilare. Senza, la textarea senza etichetta faceva
        // fallire WCAG 1.3.1 (F68) e 4.1.2 (H91) su OGNI pagina del sito,
        // login compreso — tre errori che il display:none non basta a togliere,
        // perche' HTML_CodeSniffer non guarda gli stili calcolati.
        this.elements.body.insertAdjacentHTML("beforeend",
            `<form id="overleaf-form" action="https://www.overleaf.com/docs" method="post" target="_blank" style="display: none;" aria-hidden="true"><textarea name="snip[main.tex]" id="overleaf-snippet" tabindex="-1" aria-hidden="true" title="Sorgente TeX inviato a Overleaf"></textarea></form>`);
    },
