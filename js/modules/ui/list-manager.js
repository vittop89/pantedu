...
export const ListManager = {
    ...
    _getTopLevelBlock (node, editorEl) {
        let current = node;
    ...
    _convertListTo (newTag, styleType, type) {
    ...
    _setListStyle (list, styleType, type) {
        if (!list) return;
    ...
    _handleDSACheckboxChange (checkbox) {
     ...
     */
    _saveDSACheckboxToServer (li, isChecked) {
    ...
    addDSACheckboxesToExistingLists () {
