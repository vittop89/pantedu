...
export const ContainerHeightManager = {
    ...
    updateHeight (wrapper, elementTikzGroups, elementTracciaGroups, elementBackupList, forceUpdate = false) {
    ...
    startMonitoringGroupOptions (wrapper, elementTikzGroups, elementTracciaGroups, elementBackupList) {
        const wrapperEl = asElement(wrapper);
        if (!wrapperEl) return;
    ...
    stopMonitoringGroupOptions (wrapperId) {
