...
export function createListKeyHandlers(deps) {
    ...
    function attach(field) {
        ...
        field.addEventListener("paste", (e) => {
            ...
            // 2026-09-05 — anche le classi BEM dei box inline (fm-dots/fm-add-text-dsa).
            const KEEP_CLASSES = /\b(dots|fm-dots|AddTextDSA|fm-add-text-dsa|fm-dsa-li-list|fm-text|fm-latex)\b/;
            const removeList = [];
