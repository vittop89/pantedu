...
import { escHtml } from "../modules/core/dom-utils.js";
// Il tema: la pagina è a sé (niente shell), e la politica è quella di tutte le
// altre (js/tema-iniziale.js, A-50). Prima qui era scuro solo con la scelta salvata.
...
function ensureMathJax() {
    ...
    s.id = "MathJax-script";
    s.async = true;
    // 2026-09-04 — MathJax servito dall'istanza (copiato da npm al build,
    // tools/build/vendor-assets.mjs), non più da un CDN. La config in
    // _mathjax_loader.php imposta loader.paths.fonts sullo stesso vendor.
    s.src = window.FM_MATHJAX_SRC || "/vendor/mathjax/tex-mml-chtml.js";
...
// Escape HTML: quello di core/dom-utils.js (i delimitatori LaTeX \(...\)
// restano: MathJax legge il textContent). La copia locale non codificava le
// virgolette, e finiva anche in un attributo `class` (23/9/2026, A-21).
