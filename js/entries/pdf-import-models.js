 ...
 */
import { getProviderOperations, saveProviderOperation, saveProviderPrompt, toggleCache } from "../modules/pdf-import/api.js";
import { openKeyModal } from "../modules/pdf-import/key-modal.js";
// Il tema con la politica di tutte le pagine (js/tema-iniziale.js, A-50).
import "../tema-iniziale.js";

const PROV_LABELS = {
    anthropic: "Claude (Anthropic)", openai: "OpenAI", ollama: "Ollama",
};
