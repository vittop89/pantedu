 ...
 *
 * Si carica a richiesta con `ensurePtEditorLoaded()` (components/risdoc/
 * _pt-loader.js), che passa da `caricaEntry` (core/carica-entry.js); dopo,
 * <fm-risdoc-pt-editor> è registrato e window.FM.Pt.ptToHtml disponibile.
 */
