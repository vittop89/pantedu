                    ...
                    <div class="modal-body">
                        ${this.fields?.length ? html`
                            <section>
                                ...
                                <p class="campi-spiega">
                                    Si riempiono alla generazione: il contesto dai selettori del
                                    documento, nome, Istituto e anno scolastico dal profilo. Un
                                    campo che nessuno riempie resta scritto così com'è.
                                </p>
                            </section>
                        ` : ""}
                        <section>
