...
import { campiOfferti } from "../../modules/risdoc/campi-del-documento.js";
...
export class FmRisdocPtSection extends LitElement {
    ...
    render() {
        ...
        // I campi da proporre in «Inserisci riferimento a campo»: quelli che il
        // documento risolve sempre, più il contesto che ha adesso. Prima erano
        // le sole chiavi dello stato — su un modello aperto senza contesto una
        // voce sola, e fra quelle anche le impostazioni tecniche.
        const suggested = campiOfferti(this.state, s.selectors);
