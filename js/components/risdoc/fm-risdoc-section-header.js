...
export class FmRisdocSectionHeader extends LitElement {
    ...
    static styles = css`
        ...
        .header {
            text-align: center;
            padding: 0 0 11px 0;
            /* 2026-09-19 (problema M, revisione PR #149): il fallback era il
               colore saturo sostituito ovunque nel resto del progetto da
               --fm-c-mappa-bg (css/tokens.css); qui era rimasto letterale
               perché il grep dell'audit originale copriva solo css/, non
               js/. #ddeef2 = valore chiaro di --fm-c-mappa-bg, stesso
               fallback che usava la vecchia views/admin/risdoc.php
               (orfana, tolta il 23/9/2026). */
            background: var(--fm-risdoc-header-bg, linear-gradient(180deg, #ddeef2 34%, #1d6293 100%));
