...
- **BEM moduli**: prefisso `.fm-` (progetto-precedenteed) — `.fm-card`, `.fm-btn--primary`,
  `.fm-modal__header`
...
| K | 2026-05-24 | 5 HOT classes → BEM (vedi [[decisions/ADR-019-css-hot-classes-full-bem-migration]]) | 1007 refs cross-stack |
