...
Lit 3 non è mai entrato in `package.json`: i 21 componenti lo importano a
runtime da un CDN (`lit@3`, senza fissaggio di versione né integrità) e
Vite lo lascia esterno al bundle. Contraddice la conseguenza «richiede
bundler» dichiarata sopra. La revisione architetturale di settembre 2026
lo registra come debito 16 e propone di installarlo da npm e bundlarlo
(report P3). Il resto della decisione resta valido.
