...
### Dual-role super_admin (docente.uno)
...
4. **D5-D6** — Rotation + classe_keys per pubblicazione studenti. *(Nota del
   14/9/2026: le chiavi di classe non sono mai state usate e sono uscite con
   [[decisions/ADR-037-pubblicazioni-e-copie]], fase 4.)*
