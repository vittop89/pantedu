...
final class Kernel
{
    ...
    private array $middlewareMap = [
        ...
        // TOS_ENFORCE=false). Applicato globalmente in handle(); l'alias
        // resta per i test e per un eventuale uso mirato.
...
/* best-effort */
        ...
        try {
            ...
            $execute = function (Request $r) use ($execute): Response {
                return (new \App\Middleware\TosAcceptanceMiddleware())->handle($r, $execute);
            };
            try {
