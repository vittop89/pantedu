...
final class Router
{
    ...
    /**
     * Tutte le rotte dichiarate, in ordine di dichiarazione.
     *
     * Serve al controllo che verifica la copertura CSRF sulla tabella delle
     * rotte (tests/Unit/Core/CoperturaCsrfTest.php). Il dispatch non ne ha
     * bisogno — `match()` scorre la lista per conto suo — ma senza un modo di
     * leggerla dall'esterno quel controllo non si può scrivere, e la regola
     * semgrep che ci provava non ha mai funzionato.
     *
     * @return list<Route>
     */
