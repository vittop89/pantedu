...
final class MiurSchoolsService
{
    ...
    /**
     * 2026-09-08 — mancava `_key`, che `loadIndex()` dichiara di restituire e
     * il codice costruisce: la forma della cache e quella del valore di
     * ritorno erano due dichiarazioni diverse per la stessa cosa.
     *
     * @var list<array{denom:string,type:string,city:string,prov:string,reg:string,code:string,_key:string}>|null
     */
