...
final class UserDataExportService
{
     ...
     * 2026-09-08 — la forma dichiarata diceva `sha256`, ma la chiave prodotta
     * si chiama `files_sha256`, e ogni voce porta anche `size`. Due errori in
     * una riga di documentazione, su un metodo che descrive un export di dati
     * personali: chi si fidava della firma cercava una chiave che non c'era.
     *
     * @return array<string,array{label:string, files_count:int, total_size:int, summary:array, files_sha256:list<array{path:string,sha256:string,size:int}>}>
     */
    ...
    public static function default(): self
    {
        ...
        // ADR-037, S6 — dove e con che stato i contenuti sono pubblicati.
        $svc->register(new Exporters\PubblicazioniExporter());
        ...
        // ADR-037, fase 4a — le esportazioni di published_content e classe_keys
        // sono uscite con le tabelle, sempre vuote: dove un contenuto è
        // pubblicato lo dice PubblicazioniExporter, qui sopra.
