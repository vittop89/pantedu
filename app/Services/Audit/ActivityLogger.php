...
final class ActivityLogger
{
    ...
    {
        // Via la query string: /analytics/nav?x=1 e' comunque un beacon.
    ...
    private static function write(
        ...
        try {
            ...
            $stmt->execute([
                ...
                // 23/9/2026 — senza query string e con i gettoni mascherati:
                // l'URI intero restava due anni, col gettone permanente del
                // QR di classe o quello del consenso del genitore dentro
                // (A-81). Qui, dove passano tutte le righe, e non nei
                // chiamanti: `request()` e `event()` ne hanno due diversi.
                substr(PercorsoSenzaGettoni::perIlRegistro($path), 0, 512),
                $status,
                $outcome,
                $subjectType,
