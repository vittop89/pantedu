 ...
 * I percorsi li dice `app/Config/auth.php` (`auth.paths.blocked_*`), che e'
 * anche chi li fa scrivere a `WafSecurityRepository`: dal 20/9/2026 stanno in
 * `<dati>/storage/security/`, con il database come fonte di verita'.
