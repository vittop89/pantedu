 ...
 * Un codice accettato non vale una seconda volta: lo consuma
 * TwoFactorPolicy::verifyTotp con users.totp_last_counter (23/9/2026).
 */
final class TotpService
{
     ...
     *
     * Dice solo se il codice e' giusto, non se e' gia' stato usato: per
     * l'accesso si passa da TwoFactorPolicy::verifyTotp, che lo consuma.
     */
    public function verifyCode(string $secret, string $code, ?int $timestamp = null): bool
    {
        return $this->matchingCounter($secret, $code, $timestamp) !== null;
    }

    /**
     * Il passo (secondi Unix diviso 30) a cui appartiene il codice, dentro la
     * finestra ±1; null se il codice non e' giusto.
     *
     * 23/9/2026 — serve a consumare il codice (RFC 6238 §5.2): chi verifica
     * ricorda l'ultimo passo accettato e rifiuta tutto cio' che non viene
     * dopo. Senza, lo stesso codice apriva l'accesso per circa novanta
     * secondi, quante volte si voleva (revisione 2026-09, rilievo A-65).
     */
