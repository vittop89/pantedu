...
final class HtmlSanitizer
{
    ...
    /** Feature flag — override per rollback istantaneo in caso regressione. */
    private static function isEnabled(): bool
    {
        // Default ON. Si spegne SOLO con XSS_SANITIZE_ENABLED=false per debug
        // (security.xss_sanitize_enabled, app/Config/security.php).
        return (bool)\App\Core\Config::get('security.xss_sanitize_enabled', true);
    }
    ...
    {
        // Dati d'istanza: è cache rigenerabile, ma nella radice del repository
        // (nel container, l'immagine) si rigenerava da capo a ogni rilascio e
        // nel frattempo gonfiava lo strato scrivibile.
        $base = \App\Support\PercorsiDati::base(dirname(__DIR__, 3)) . '/storage/htmlpurifier-cache';
        if (!is_dir($base)) {
