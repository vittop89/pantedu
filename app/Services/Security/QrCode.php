...
final class QrCode
{
    ...
    /**
     * Matrice dei moduli: 1 nero, 0 bianco.
     *
     * Indicizzata da interi e non `list<...>`: nasce da `array_fill`, quindi a
     * runtime le chiavi sono consecutive, ma dopo le scritture con indici
     * calcolati non è più dimostrabile — e per i parametri passati per
     * riferimento la promessa deve reggere anche all'uscita.
     *
    ...
    /** @return array<int, array<int, int>> copia mascherata della matrice */
    ...
    /** @param array<int, array<int, int>> $m Penalita' ISO 18004 §6.8.3: piu' bassa, piu' leggibile. */
