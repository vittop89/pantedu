...
final class EmailSecondFactor
{
    ...
    private function send(string $to, string $username, string $code): bool
    {
        ...
        // 23/9/2026 — il collegamento era scritto con il dominio di
        // produzione, anche su un'altra istanza. Adesso è `app.url`; senza, il
        // codice parte lo stesso e il collegamento no: il messaggio serve al
        // codice, e bloccare l'accesso per un collegamento di cortesia
        // sarebbe peggio (IndirizzoPubblico registra l'anomalia).
        $sito = IndirizzoPubblico::radiceSeConfigurata('secondo_fattore');
        $dove = $sito !== null ? "da $sito/me/change-password" : 'dalla pagina del tuo account';
        $body = "Ciao $username,\n\n"
