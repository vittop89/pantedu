...
TEX;
    ...
    public static function buildContext(array $teacher, array $selection, array $extra = []): array
    {
        ...
        // Senza scuola, niente scuola (24/9/2026): il ripiego era il nome di un
        // istituto vero, stampato sulle verifiche di qualunque docente.
        $istituto    = (string)($selection['istituto'] ?? $extra['istituto'] ?? '');
