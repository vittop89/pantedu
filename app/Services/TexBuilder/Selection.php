...
final class Selection
{
    ...
    /**
     * @var list<array{filePath:string,problemId:string,position:int,type:string,text:string,items:list<array>}>
     *
     * 2026-09-08 — `type` mancava nella forma dichiarata pur essendo scritto
     * sempre da `fromArray()`. Chi leggeva la firma non sapeva che c'era, e
     * chi lo leggeva davvero — `TableRenderer`, e le prove — risultava
     * sbagliato al controllore statico.
     */
