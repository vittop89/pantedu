...
final class ProviderRouter
{
    private const CLIENTS = [
        ...
        // Ogni fornitore spedito nella configurazione d'esempio è un DPA da
        // verificare, una riga nel registro art. 30 e una base giuridica di
        // trasferimento da reggere (GDPR art. 44 e ss.). Qwen è extra-SEE con
        // SCC mai verificate; OpenRouter instrada verso terzi scelti da uno
        // slug di modello, quindi i sub-responsabili non sono enumerabili in
        // anticipo — inaccettabile in un DPA con un istituto scolastico.
        // Restano due fornitori cloud più l'opzione locale senza trasferimenti.
    ];
    ...
    public function isConfigured(string $name): bool
    {
        ...
        return match ($name) {
            'anthropic', 'openai' => $this->keyFor($name) !== '',
