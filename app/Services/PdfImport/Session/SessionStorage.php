...
final class SessionStorage
{
    ...
    private function encBlob(int $teacherId, string $bytes): string
    {
        try {
            ...
            // Una chiave presente ma malformata conta come presente: si ferma
            // anche lei (23/9/2026, A-36: la lettura sta in ChiaveMadre).
            if (ChiaveMadre::dallAmbiente()->presente()) {
                throw $e;
            }
