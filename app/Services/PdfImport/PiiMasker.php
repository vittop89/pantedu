...
final class PiiMasker
{
     ...
     */
    /**
     * `int` e non `?int`: il parametro per riferimento riceve sempre un
     * numero, mai null. Il punto interrogativo prometteva un caso che non
     * esiste.
     */
    public static function mask(string $text, int &$count = 0): string
    {
        $n = 0;
