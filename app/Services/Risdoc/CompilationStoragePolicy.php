 ...
 *
 * PERCHE' (2026-09-04)
 *   I modelli della categoria `modelli` servono a redigere BOZZE di atti
 *   della scuola — non gli atti, che si formano e si conservano altrove
 *   (ToS 2.5) — e
 *   parlano di studenti per natura (relazione finale, schede di recupero).
 *   Il Titolare della piattaforma puo' decidere che per i docenti di un
 *   Istituto la compilazione non resti sul server: e' una sua scelta, non
 *   l'esecuzione di un'istruzione dell'Istituto (2026-09-22, vedi
 *   CompilationController::save). L'amministratore lo imposta per
