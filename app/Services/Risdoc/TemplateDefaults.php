 ...
 * l'unica dipendenza di contesto è TeacherContextResolver::privateFilesInstituteId.
 *
...
final class TemplateDefaults
{
    ...
    {
        // privateFilesInstituteId tocca il DB: avvolgiamo tutto per ritornare null
