    ...
    public function approve(int $pendingId, int $reviewerId, ?string $note = null): array
    {
        ...
        try {
            ...
            if ($row['content_encoding'] === 'base64') {
                ...
                // Dati d'istanza (PANTEDU_DATA_PATH): stessa cartella che usa
                // TemplateController per il salvataggio diretto. Nel container la
                // radice del repository è l'immagine e il binario approvato si
                // perderebbe al rilascio.
                $base = \App\Support\PercorsiDati::base(\dirname(__DIR__, 3)) . '/storage/overrides/institutional';
