...
final class GitHubSyncService
{
    ...
    private function apiRequest(string $pat, string $method, string $path, ?array $jsonBody = null): array
    {
        ...
        // (App\Support\BundleCa). Fino al 23/9/2026 qui si cercava un
        // `cacert.pem` sotto la cartella storage del codice, un file che il
        // repository non ha mai portato (A-42).
