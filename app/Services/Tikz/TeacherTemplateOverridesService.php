 ...
 *     (scritto da TikzElementsService a ogni CRUD admin).
...
final class TeacherTemplateOverridesService
{
    ...
    {
        $this->basePath = rtrim(str_replace('\\', '/', $basePath ?? (string) Config::get('app.paths.data_base', dirname(__DIR__, 3))), '/');
    }
    ...
    /** Carica index admin defaults (scritto da TikzElementsService). */
