...
final class TikzRenderService
{
    ...
    public function __construct(
        ...
        // La cache è un dato d'istanza: sta nella cartella dei dati
        // (PANTEDU_DATA_PATH), non nella radice del repository. Nel container
        // la radice è l'immagine, e ciò che ci si scrive si perde a ogni
        // rilascio (misurato il 19/9/2026 con `docker diff`).
        $base = $basePath ?? (string) Config::get('app.paths.data_base', dirname(__DIR__, 3));
