...
final class VerificaController
{
    ...
    public function listForStudent(Request $req): Response
    {
        try {
            ...
            if (!$u) {
                // ADR-032 — ospite con credenziale di classe: le verifiche
                // condivise fra colleghi (shared_with_pool) non sono una
                // pubblicazione agli studenti; lista vuota, non un errore.
                if (\App\Support\ClassAccessGrant::isActive()) {
