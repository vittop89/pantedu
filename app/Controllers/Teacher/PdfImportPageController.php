...
final class PdfImportPageController
{
    ...
    public function page(Request $req): Response
    {
        ...
        // apre in nuova scheda. Carica solo il CSS bundle + l'entry Vite. Il tema
        // lo applica l'entry, con la politica di tutte le pagine
        // (js/tema-iniziale.js, 23/9/2026, A-50).
...
HTML;
    ...
    private function buildContent(bool $enabled, array $providers, bool $rasterOk, bool $isAdmin = false, bool $cacheOn = false, array $autoSet = []): string
    {
        ...
        $opts = '';
        $labels = ['anthropic' => 'Claude (Anthropic)', 'openai' => 'OpenAI', 'ollama' => 'Ollama locale'];
    ...
    <section class="fm-pdfimport__insertbar" data-fm-insertbar hidden aria-label="Operazioni e inserimento">
        ...
        {$chkDiff}<button type="button" class="fm-pdfimport__btn" data-fm-refine-diff title="Rilegge la difficoltà dai pallini con un modello vision dedicato">Ricalcola difficoltà ●●○</button>
