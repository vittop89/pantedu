...
final class RegistrationController
{
    ...
    {
        // APP_MAIL_FROM, non MAIL_FROM: quest'ultima non è mai esistita in
        // .env.example, quindi il guard qui sotto non è mai scattato e il
        // From cadeva sempre sul default hardcoded. Senza fallback: vuoto
        // significa "non inviare", com'è documentato in .env.example.
    ...
    public function submit(Request $req): Response
    {
        ...
        try {
            ...
            $out = $this->svc->submit([
                ...
                // Serve a registrare l'accettazione ToS/AUP con gli stessi
                // metadati probatori promessi dai documenti (identità,
                // timestamp, IP, User-Agent).
                'user_agent'     => $req->server['HTTP_USER_AGENT'] ?? null,
