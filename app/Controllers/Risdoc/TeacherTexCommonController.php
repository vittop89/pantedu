...
final class TeacherTexCommonController
{
    private const TEX_COMMON_FILES = [
        ...
        // 2026-09-04 — dati dell'Istituto per l'intestazione. Non ha un file
        // di default su disco: l'export lo genera dal profilo del docente;
        // qui il docente (o l'istanza) puo' scriverne uno completo.
        'risdoc-istituto.tex',
    ];
    ...
    public function previewPdf(Request $req): Response
    {
        ...
        if ($path === '' || !\in_array($path, self::TEX_COMMON_FILES, true)) {
            return Response::fail('path_required_or_invalid', 400);
        }
