...
use App\Repositories\Risdoc\CurriculumDataRepository;
...
final class CurriculumOptionsController
{
    ...
    public function options(Request $req): Response
    {
        ...
        if ($opts === null) {
            ...
            // Cascata: prima i dati d'istanza, poi il codice. L'albero è
            // versionato e viaggia dentro l'immagine, ma dal 20/9/2026
            // `RisdocAdminController` salva le modifiche nei dati (prima le
            // scriveva sopra l'immagine, e il rilascio le buttava via).
            // Leggendo solo dal codice, la modifica dell'amministratore
