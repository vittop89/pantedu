...
// Phase 24.36 — accept anche content-{id}-{hex}.zip da TeacherContentController
    ...
    public function export(Request $req, array $params): Response
    {
        ...
        // Images: se presenti nella sorgente origin/images. Il logo della
        // scuola non sta piu' nel repo: e' un file dell'istanza per l'Istituto
        // del docente (InstituteAssets), aggiunto qui col nome che il template
        // si aspetta. Se manca, l'intestazione lo salta.
...
// Sostituisce [field] sequenziali con i valori .field in ordine (se formState ha 'fields' array)
     ...
     */
    private function loadIstitutoTex(int $tid, int $templateId, \App\Services\Risdoc\OverrideRepository $repo, array &$overrides): string
    {
