...
final class TeacherCredentialController
{
    ...
    // ADR-032 — la chiave vive in ClassAccessGrant, che e' l'unico a saperla
    // leggere lato studio (prima nessuno la leggeva).
    private const SESS_KEY = \App\Support\ClassAccessGrant::SESSION_KEY;
