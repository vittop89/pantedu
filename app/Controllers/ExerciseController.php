...
final class ExerciseController
{
     ...
     *
     * @deprecated G22.S15.bis Fase 5+ (PROBLEM-16) — da non usare in codice
     *   nuovo: al suo posto /api/study/content.json + /api/teacher/content
     *   (ContractRepository-based). Pianificato remove in Phase 26 con la
     *   tabella legacy `exercises`. Ancora chiamato, però: lo usa la vista
     *   views/exercises/search.php (entry js/entries/exercises-search.js). Il
     *   «ZERO callers» di prima era falso (revisione del 23/9/2026, DOC-27).
     */
