 ...
 *   - corpoJson(): JSON body validato (max 2 MiB), dal lettore comune
...
trait VerificaSharedHelpersTrait
{
    ...
    /**
     * Il corpo JSON delle API delle verifiche e dell'import PDF: il lettore
     * comune di ADR-034 con il limite di queste rotte, 2 MB. Fino al 23/9/2026
     * qui c'era una copia di `readJsonBody()`, e un corpo troppo grande
     * rispondeva 400 attraverso `statusFor()` (A-52): adesso 413, sempre.
     *
     * @return array<mixed>
     */
    private function corpoJson(Request $req): array
    {
