...
final class PasswordResetController
{
    ...
    public function showReset(Request $req): Response
    {
        ...
        // Il gettone è nell'indirizzo della pagina (anche quando submitReset
        // ci torna con un errore): non va come Referer al modulo, ai fogli di
        // stile, agli script (24/9/2026, PaginaConGettone).
        return PaginaConGettone::html([
            'title' => 'Nuova password — Pantedu',
            'body'  => View::default()->render('auth/password_reset', [
                'csrf'  => Csrf::token(),
                'token' => $token,
                'valid' => $valid,
