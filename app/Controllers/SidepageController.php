    ...
    private function enforceCategoryAcl(string $category): ?Response
    {
        switch ($category) {
            ...
            case 'bes':
                ...
                // 2026-09-14 — la lista scritta a mano aveva 'admin', che in
                // database non c'è (l'amministratore è `administrator`): gli
                // argomenti di verifiche e BES gli rispondevano 403. È la zona
                // «teacher» di app/Config/roles.php, e si chiede quella.
                if (!Auth::hasAccess('teacher')) {
