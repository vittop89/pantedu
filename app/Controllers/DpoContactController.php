...
final class DpoContactController
{
    ...
    private function sendAcknowledgmentEmails(
        ...
        // APP_MAIL_FROM, non MAIL_FROM: quest'ultima non è mai stata definita
        // in .env.example, quindi il From cadeva sempre sul default.
        ...
        try {
            ...
            $ackSent = $mailer->send($emailLower, $ackSubject, $ackBody, $dpoTo);
        } catch (Throwable $e) {
