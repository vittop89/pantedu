...
final class ExerciseStudyController
{
    public function topicsPage(Request $req, array $params): Response
    {
        ...
        $filters = $policy->apply([
            ...
            // G19.8 — accetta sia "2" (nuovo short) sia "2s" (legacy URL); la tabella
            // exercises ha i codici brevi (2026-09-05: expand() li allungava e trovava 0 righe).
            'classe'    => isset($params['classe']) ? \App\Support\ClsNormalizer::shrink((string)$params['classe']) : null,
    ...
    public function topicsJson(Request $req): Response
    {
        ...
        $filters = $policy->apply([
            ...
            'classe'    => isset($q['classe']) ? \App\Support\ClsNormalizer::shrink((string)$q['classe']) : null,
    ...
    private function wrapInShell(Request $req, string $body, string $title): Response
    {
        ...
        // contenuto è HTML statico dal DB, basta MathJax.
