...
final class SpidController
{
    ...
    {
        // `auth.spid.enabled` non è mai esistita: la chiave vera è
        // `spid.enabled` (app/Config/spid.php), letta da SPID_ENABLED. Il
        // ripiego diretto su $_ENV, vietato fuori da app/Config, è tolto
        // (revisione architetturale del 23/9/2026, A-34; ADR-049).
        return (bool)Config::get('spid.enabled', false);
    }
