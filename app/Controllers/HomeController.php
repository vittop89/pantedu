...
final class HomeController
{
    public function index(Request $req): Response
    {
        ...
        // SecurityHeadersMiddleware applica la CSP (strict: nonce, che le viste
        // scrivono sugli script dell'app dal 23/9/2026, A-16) come per ogni
        // altra pagina. app.php è auto-sufficiente
