...
final class CriticalCss
{
    ...
    public static function inline(): string
    {
        ...
        // Il nonce della CSP della richiesta (23/9/2026, A-16). Prima si leggeva
        // da un'intestazione X-CSP-Nonce della richiesta, che nessuno imposta:
        // lo `<script>` qui sotto lo riceveva solo dalla timbratura del
        // middleware, che non c'è più. Sullo `<style>` non serve (style-src ha
        // 'unsafe-inline' e niente nonce), ma non fa danni: resta.
        $csp = Csp::attributo();
...
<script{$csp}>(function(l){l&&l.addEventListener("load",function(){this.onload=null;this.rel="stylesheet"},{once:true})})(document.currentScript.previousElementSibling)</script>
