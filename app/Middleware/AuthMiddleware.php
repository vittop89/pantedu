...
final class AuthMiddleware
{
    ...
    public function handle(Request $req, callable $next): Response
    {
        ...
        // 23/9/2026 — la sessione è ancora quella del login? Ruolo, stato e
        // flag di super-admin si rileggono dal database al più ogni
        // Auth::CLAIMS_TTL_SECONDS (revisione 2026-09, rilievo A-66). Prima si
        // leggevano solo al login: un account disattivato restava dentro fino
        // a dodici ore, con il ruolo che aveva. Account sparito, disattivato,
        // con un ruolo o un flag di super-admin diversi: la sessione si chiude
        // (riga `session_revoked`) e la risposta è quella di chi non ne ha
        // una. Al login dopo si ripassa dai controlli del login, secondo
        // fattore compreso.
    ...
    /** Senza sessione valida: 401 a chi chiede JSON, il login alle pagine. */
