...
final class InstituteRepository
{
    ...
    public function listWithUsage(): array
    {
        ...
        // 2026-09-14 — lo stesso per `sezioni_docenti`, che arriva con la 126.
        try {
            return $this->listWithUsageQuery('i.compilation_storage, i.sezioni_docenti,');
        } catch (\PDOException) {
            try {
     ...
     * (false). La decide il Titolare della piattaforma, con motivazione a
     * registro; nessun soggetto esterno la determina. Vedi
     ...
     * (es. MIUR-ESEMPIO-COMUNE_ESEMPIO-ART) e NON matchano. Usato per scegliere il
