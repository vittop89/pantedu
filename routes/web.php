...
$router->get ('/me/custody-events',     [\App\Controllers\SelfServiceController::class, 'custodyEvents']);
...
// parte, e quelle letture non lasciavano traccia. Le scritture hanno gia'
// `audit_reason` e il registro globale in Kernel.
$router->group(['middleware' => ['auth', 'role:admin', 'super_admin_required', 'log', 'sadmin_audit:admin_read,governance']], function (\App\Core\Router $r) {
    ...
    // Istituto si salvano sul server o restano nel browser: scelta per Istituto,
    // su indicazione del suo DPO (CompilationStoragePolicy).
