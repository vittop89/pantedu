...
<div class="fm-card fm-card--form">
    ...
    <?php else: ?>
        ...
        <form method="post" action="/me/change-password" autocomplete="on" data-full-reload>
            ...
            <input id="confirm_password" class="fm-input" type="password" name="confirm_password" data-fm-match="#new_password" data-fm-match-message="Le password non corrispondono"
                   autocomplete="new-password" minlength="8" maxlength="4096" required>

            <?php /* Un toggle per campo (js/modules/features/password-visibility.js):
                     qui la password si digita tre volte, ed e' il punto in cui
                     un refuso non visto costa di piu' — la nuova password
                     sbagliata due volte uguali viene accettata, e si resta
                     chiusi fuori subito dopo averla cambiata. */ ?>
            <label class="fm-pwtoggle">
                <input class="fm-pwtoggle__input" type="checkbox" data-pw-toggle="new_password">
                <span class="fm-pwtoggle__text">Mostra la nuova password</span>
            </label>
            <label class="fm-pwtoggle">
                <input class="fm-pwtoggle__input" type="checkbox" data-pw-toggle="confirm_password">
                <span class="fm-pwtoggle__text">Mostra la conferma</span>
            </label>
