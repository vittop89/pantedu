...
<main class="fm-ex-search">
    ...
    <form id="fm-ex-form" class="fm-ex-filters">
        <select name="indirizzo" aria-label="Indirizzo">
        ...
        <select name="materia" aria-label="Materia">
            <option value="">— materia —</option>
            <option value="MAT">MAT</option><option value="FIS">FIS</option>
        </select>
        <select name="difficulty" aria-label="Difficoltà">
        ...
        <input type="text" name="topic" placeholder="topic (es. Limiti)" aria-label="Argomento" />
...
<?= \App\Support\ViteManifest::script('js/entries/exercises-search.js') ?>
</body>
</html>
