...
<?php /* 23/9/2026 (A-17) — admin-verifica-templates, admin-tikz-templates e
         admin-options-sources arrivano dall'entry, nel bundle: prima erano
         serviti grezzi da /js/ accanto al bundle, senza impronta e con un
         giorno di cache, e dom-utils e sync-panel giravano in due istanze. */ ?>
<?= \App\Support\ViteManifest::script('js/entries/admin-templates.js') ?>
