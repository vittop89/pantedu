            ...
            ?>
                <tr>
                    ...
                    <td class="fm-d-flex fm-gap-1">
                        ...
                        <form data-fm-confirm="Eliminare questo sub-processor?" method="POST" action="/admin/subprocessors/<?= $id ?>/delete"
                              class="fm-d-inline">
                            <input type="hidden" name="_csrf" value="<?= $h($csrf) ?>">
                            <input type="hidden" name="_audit_reason" value="Eliminazione del sub-processor #<?= $id ?> dal registro, confermata nel pannello">
