...
$contentScopes = [
    ...
    'pubblicazioni'     => ['📍', 'Pubblicazioni', 'Dove e con che stato sono pubblicati contenuti e verifiche'],
...
<form method="POST" action="/admin/gdpr/authority-export" enctype="application/x-www-form-urlencoded" id="fm-auth-export-form">
    ...
    <input type="hidden" name="_audit_reason" value="Esportazione dei registri per una richiesta dell'autorità (dati nel modulo)">
        ...
        <div class="fm-form-grid">
            ...
            <div class="fm-form-fullrow">
                ...
                <div class="fm-d-flex fm-gap-2 fm-mt-1 fm-items-center fm-flex-wrap">
                    <button data-fm-action="fmContentSearchOpen" type="button" class="fm-btn fm-btn--ghost fm-btn--sm">
            ...
            <div id="fm-content-search-panel" class="fm-form-fullrow fm-content-search-panel fm-d-none" >
                <div class="fm-d-flex fm-gap-2 fm-mb-2 fm-flex-wrap fm-items-end">
                    ...
                    <button data-fm-action="fmContentSearchRun" type="button" class="fm-btn fm-btn--primary fm-btn--sm">🔎 Cerca</button>
                    <button data-fm-action="fmContentSearchClose" type="button" class="fm-btn fm-btn--ghost fm-btn--sm">✕ Chiudi</button>
                </div>
...
<?= \App\Support\ViteManifest::script('js/entries/admin-gdpr-authority-export.js') ?>
