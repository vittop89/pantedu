...
<div class="fm-bc-row">
    ...
    <div class="fm-tb-actions">
        ...
        <a class="fm-btn fm-btn--ghost fm-btn--sm" href="/me/2fa" title="Verifica in due passaggi: app di autenticazione o codice via email, codici di backup">🛡️ Due fattori</a>
    ...
    <nav class="fm-admin-toolnav fm-admin-toolnav--menus" aria-label="Admin tools">
        ...
        $_tool_groups = [
            ...
            'Istituto & contenuti' => [
                ...
                ['href' => '/admin/sections',       'icon' => '🎯', 'label' => 'Sezioni',   'super' => true],
