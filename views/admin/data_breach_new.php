...
<form method="POST" action="/admin/data-breach/new"
    ...
    <input type="hidden" name="_audit_reason" value="Apertura di un incidente nel registro delle violazioni (art. 33-34 GDPR)">
    ...
    <div class="fm-field">
        <label for="db-titolare_esterno">Titolare dei dati, se non siamo noi</label>
        <input type="text" id="db-titolare_esterno" name="titolare_esterno" maxlength="255"
               placeholder="es. l'Istituto presso cui insegna il docente" class="fm-w-full">
        <p class="fm-muted fm-text-13 fm-mt-1">Si compila quando i dati coinvolti riguardano persone di cui &egrave; titolare un altro soggetto &mdash; tipicamente la scuola di un docente, per un dato scritto in un campo a testo libero (rischio R20). In quel caso va avvisato <strong>senza ingiustificato ritardo</strong>: &egrave; l'unico che possa adempiere verso i propri interessati, e lo sa solo da noi.</p>
    </div>
