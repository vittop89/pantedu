...
<?php if (isset($_GET['error'])): ?>
    <div class="fm-alert fm-alert--danger" role="alert">
        Azione non applicata: <?= $h($_GET['error']) ?>
    </div>
<?php elseif (isset($_GET['ok'])): ?>
    ...
    <?php if (($_GET['notice'] ?? '') === 'uploader_not_notified'): ?>
        <div class="fm-alert fm-alert--warn" role="alert">
            ...
            identificato, senza email, o mailer non configurato). Fase 4 della procedura
            va completata a mano da <code>operatore@example.net</code>: vedi il template §5.2 in
            <a href="/legal/takedown-procedure">Notice &amp; Takedown</a>.
        </div>
    <?php endif; ?>
<?php endif; ?>
