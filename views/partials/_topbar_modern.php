 ...
 * primarie (SalvaTEX, ZIP, GENERA, filtri, Editor) coerenti col
 * design system (gradient, dark-theme aware).
 *
 * Bridge invisibile: contiene gli hidden input (#Server,
...
<div class="fm-topbar" id="fm-topbar"
    ...
    <div class="fm-topbar__zone fm-topbar__zone--target" role="toolbar" aria-label="Azioni documento">
        <button type="button" class="fm-topbar__btn fm-topbar__btn--primary"
                ...
                title="Salva il .tex nel database e genera i PDF compilando sul servizio tex-compile.">
    ...
    <!-- Bridge invisibile: utilities.js (vanilla) legge #Server /
