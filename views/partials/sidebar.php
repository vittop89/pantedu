...
if ($_fmGrant !== null && $studentScope === null
    && $_fmGrant['indirizzo'] !== null && $_fmGrant['classe'] !== null) {
    $studentScope = ['indirizzo' => $_fmGrant['indirizzo'], 'classe' => $_fmGrant['classe']];
}
    ...
    <?php elseif ($_fmGrant !== null): ?>
        ...
        <div class="sel-session-banner fm-session-banner fm-session-banner--student">
            ...
            <div class="fm-session-ident">
                <div class="fm-session-user">🎓 <strong><?= htmlspecialchars($_fmGrant['label'] !== '' ? $_fmGrant['label'] : 'Accesso classe', ENT_QUOTES) ?></strong></div>
                <div class="fm-session-links">
