...
$tabs = [
    ...
    // Sta qui e non fra le impostazioni perche' e' l'unico modo di raggiungere
    // dei contenuti che esistono ma non compaiono da nessuna parte: la
    // navigazione filtra per indirizzo, e chi non ce l'ha resta invisibile.
    ['route' => '/area-docente/da-categorizzare', 'icon' => '🏷️', 'label' => 'Da categorizzare'],
    // I materiali nascono con la classe della barra laterale; cambiarla uno
    // per uno non lo fa nessuno. Qui si spostano a blocchi (anno → sezione).
    ['route' => '/area-docente/sposta-di-classe', 'icon' => '🔀', 'label' => 'Sposta di classe'],
];
