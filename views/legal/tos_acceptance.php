 ...
 */
$checkboxes = [
    // 24/9/2026 — le stesse cinque conferme dell'«Accettazione» dei Termini.
    // Due caselle facevano spuntare frasi che i Termini avevano tolto: che la
    // cifratura per docente impedisse all'operatore di accedere ai contenuti
    // (falso dalla 1.2: la chiave master sta sul server) e un obbligo di
    // segnalazione del DPR 62/2013 (tolto nella 1.4).
    'read_tos' => 'Ho letto e compreso i <strong>Termini di servizio</strong>, versione '
        . e($tosVersion) . ', e li accetto',
    'read_aup' => 'Ho letto e compreso l\'<strong>uso accettabile (AUP)</strong>, versione '
        . e($aupVersion) . ', e lo accetto',
    'accept_responsibility' => 'Mi assumo la piena responsabilità per i contenuti che '
        . 'caricherò (Termini §4)',
    'accept_safe_harbor' => 'Sollevo l\'operatore tecnico da responsabilità per i contenuti '
        . 'altrui (Termini §4); so che accede ai contenuti solo nei casi del §3(c)',
    'accept_takedown' => 'Mi impegno a cooperare in buona fede alle procedure di segnalazione '
        . 'e rimozione (Termini §5)',
];
?>
