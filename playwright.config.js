...
module.exports = defineConfig({
    ...
    use: {
        ...
        // Da quando AUDIT_REASON_MODE è `enforce` (2026-09-02), ogni mutazione
        // di un super-admin deve dichiarare un motivo, altrimenti risponde 400.
        // La suite ne ha molte sparse in una decina di spec: invece di ripetere
        // l'header in ognuna, lo dichiara qui una volta sola — ed è anche vero,
        // il motivo di quelle chiamate è che le sta facendo un test.
        // Uno spec che ha bisogno del caso "motivo assente" (b4_audit_reason)
        // passa una stringa vuota nella singola richiesta.
        extraHTTPHeaders: {
